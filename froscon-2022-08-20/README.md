# Flatcar Container Linux basic intro demo for FrOSCon 2022
...
Download a Flatcar release and the corresponding qemu starter script (NOT the current / most recent one; use an older version to demo updates) from [here](https://www.flatcar.org/releases/).
...
4. SSH into the instance
   ...
   ```
5. Show `/srv/www/html` with the files created, `systemctl status froscon-demo-webserver`, and `docker ps`.
   Show `journalctl -fu froscon-demo-webserver` and reload the web page.
